...
export default {
  ...
  assets: {
    ...
    'index.html': {size: 100574, hash: 'd8281be17457625e0365cf3975c678d721cb1e25e526f696289b200e8094a172', text: () => import('./assets-chunks/index_html.mjs').then(m => m.default)},
